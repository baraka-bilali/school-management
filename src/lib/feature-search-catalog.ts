...
export const FEATURE_SEARCH_ITEMS: FeatureSearchItem[] = [
  ...
  },
  {
    ...
    category: "users",
    keywords: ["cours", "attributions", "courses", "affectations", "professeur"],
    icon: Link2,
    roles: ADMIN_LIKE,
    popular: true,
  },
  {
    ...
    subtitle: "Classes & Filières",
    href: "/admin/classes?tab=subjects",
    category: "classes",
  ...
  },
  {
    ...
    href: "/admin/settings",
    category: "account",
    keywords: ["settings", "configuration", "ecole", "logo", "cycles", "maxima", "notation"],
    icon: Settings,
    roles: ADMIN_LIKE,
  },
  {
  ...
  },
  {
    ...
    subtitle: "Résultats primaire et curriculum",
    href: "/admin/grades",
    category: "overview",
    keywords: ["notes", "bulletins", "grades", "resultats", "cotation", "primaire"],
    icon: FileText,
    roles: ADMIN_LIKE,
  },
  {
