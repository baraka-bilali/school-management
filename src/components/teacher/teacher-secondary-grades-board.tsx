...
export function TeacherSecondaryGradesBoard({
  classId,
  assignmentId,
}: {
  classId: string
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {isLocked ? (
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-teal-700 px-4 py-2.5 text-sm font-medium text-white disabled:opacity-50"
          >
            Valider la période
          </button>
        )}
