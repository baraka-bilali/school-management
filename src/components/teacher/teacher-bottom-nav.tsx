...
import { teacherMobileNavItems } from "./teacher-nav"
...
export default function TeacherBottomNav({ walletPulse = false, isDark = false }: TeacherBottomNavProps) {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-lg items-center justify-around py-2">
        {teacherMobileNavItems.map(({ href, label, icon: Icon, match, badgeKey }) => {
